...
int main() {
    ...
    int nbTraining = 0;
    TrainingExample** trainingExamples = readDatabase("Tools/Data/letters_database", &nbTraining);
    ...
    //saveNetwork(network, "Tools/Data/OCR_network");
